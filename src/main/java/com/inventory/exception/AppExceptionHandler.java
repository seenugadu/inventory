...
import com.inventory.exception.dto.Error;
import com.inventory.exception.dto.ErrorResponse;
...
public class AppExceptionHandler {
    ...
    public Error getErrorMessage(String errorCode) {
        ...
        if (!StringUtils.isEmpty(errorValue)) {
            errorObject = new Error("INVENTORY_MS_" + errorCode, errorValue);
        }
        else{
            errorObject = new Error("INVENTORY_MS_4xx","Invalid request parameters - " + errorCode);
        }
